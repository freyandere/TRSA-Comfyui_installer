...
## Youtube - инструкция
[![Туториал установки ](https://github.com/user-attachments/assets/9a820ecb-fdad-49aa-921a-a4c439732228)](https://youtu.be/x6rUXL0isks "Youtube - инструкция")

**Профессиональный цветной установщик для ComfyUI Portable с Triton, SageAttention**
...
- **⚡ Фокус на производительность**: Специализированная оптимизация для **2-3x более быстрой генерации видео** с SageAttention
