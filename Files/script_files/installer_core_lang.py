...
TRANSLATIONS: Dict[str, Dict[str, Any]] = {
    "en": {
        ...
        "gpu_found": "   Found: {name} ({vram_gb:.0f} GB)",
        "gpu_compute_cap": "   Compute capability: {major}.{minor}",
        "gpu_recommended_cuda": "   Recommended: CUDA {cuda}",
        "gpu_not_found": "   No NVIDIA GPU detected.",
        "gpu_cpu_fallback": "   ComfyUI will run on CPU. This will be slower but fully functional.",
        "confirm_yes": "Y",
        "confirm_no": "n",
    },
    ...
    "ru": {
        ...
        "gpu_detecting": "   Определение вашего GPU...",
        "gpu_found": "   Найдено: {name} ({vram_gb:.0f} ГБ)",
        "gpu_compute_cap": "   Вычислительная способность: {major}.{minor}",
        "gpu_recommended_cuda": "   Рекомендуется: CUDA {cuda}",
        "gpu_not_found": "   GPU NVIDIA не обнаружен.",
        "gpu_cpu_fallback": "   ComfyUI будет работать на CPU. Это медленнее, но полностью работоспособно.",
        "confirm_yes": "Y",
        "confirm_no": "n",
    },
}
